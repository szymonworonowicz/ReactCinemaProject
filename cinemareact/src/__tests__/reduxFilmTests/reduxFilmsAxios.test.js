...
describe("getAllFilms", () => {
  ...
  it("should throw an error in action GetFilmSuccess when data is received", async () => {
    const films = [
      {
        id: 1,
        title: "film1",
  ...
  it("should throw error in action AddFilmFailure when new Film added", () => {
    const error = new Error('test')
    const newfilm = {
      id: 2,
      title: "film2",
  ...
  it("should throw error  in action updateFilmFailure when update film", () => {
    const error  = new Error('test')
    const updatedFilm = {
      id: 2,
      title: "film2",
  ...
  it("should throw an error in deleteFilmFailure when delete film", () => {
    let id = 1
    const error = new Error('test')
    const expected = [
      {
